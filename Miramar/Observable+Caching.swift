...
//TODO: need to figure out a way to create non-retaining observations
...
//
//    /// Creates an Observable that will cache the last value of the given object.
//    public convenience init<O: AnyObservableSignal>(caching other: O, initial: ValueType) where O.ValueType == ValueType {
//        self.init(caching: other, initial: initial) { $0 }
//    }
//
//    /// Creates an Observable that will cache the results of applying `transform` to the value
//    /// of the given object.
//    public convenience init<O: AnyObservableSignal>(caching other: O, initial: ValueType, _ transform: @escaping (O.ValueType) -> ValueType) {
//
//        var value = initial
//        self.init({ value })
//
